<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HB.aspx.cs" Inherits="QrPaySystem.PageHB.HB3" %>
...
<form id="form1" runat="server" style="background-color:gray;" >
                ...
                <tr>
                  <td class="auto-style4">
                      <div id="qqDiv" runat="server">
                          <a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=536400495&site=qq&menu=yes"><img border="0" src="../tools/HB_pic/qq_button.gif" alt="点击这里给我发消息" title="联系作者" /></a>     
        ...
        <div style="font-family: 宋体, Arial, Helvetica, sans-serif; background-color: #4B6C9E; margin-right: auto; margin-left: auto; width: 720px; height: auto; text-align: center; padding-top: 0px;">
              <table id="tableUpload" runat="server" width="720" border="0" cellspacing="5" cellpadding="0">
                <tr>
                    <td width="344" >
        ...
        <div class="MainPannelStyle" id="MainPannel">
              ...
              <tr>
                <td >
                    <a id="HelpLinkHB" target="_blank" href="../tools/HB_pic/help_hb.png">
                        <asp:Label ID="Label1" runat="server" Text="红包码 如何获取？"></asp:Label>
                    </a>                </td>
                <td class="auto-style3" >
                    <a id="HelpLinkSK" target="_blank" href="../tools/HB_pic/help_sk.png">
                        <asp:Label ID="Label2" runat="server" Text="收款码 如何获取？"></asp:Label>
                    </a>                </td>
              </tr>
              <tr>
                <td><div align="center"><img src="../tools/HB_pic/adding_hb.png" alt="添加您的红包码" name="img_HB" width="329" height="495" border="2" id="img_HB" onclick="javascript:Qr_Scan_Hb();" runat="server" /></div></td>
                <td class="auto-style3"><div align="center"><img src="../tools/HB_pic/adding_sk.png" alt="添加您的收款码" name="img_SK" width="334" height="499" border="2" id="img_SK"  onclick="javascript:Qr_Scan_Sk();" runat="server" /></div></td>
              </tr>
                  
              <tr>
                <td class="auto-style3">
                    <%--<asp:Button ID="Button1" runat="server" onclick="javascript:Qr_Scan_Hb();" Text="扫一扫" />--%>

                    <button  id="J_btn_hb_scanQR" runat="server" onclick="javascript:FileUpload_HB_SelectFile();" >上传</button>
                    <asp:TextBox ID="TextBox_HB" Text="红包码" MaxLength="200" runat="server" ToolTip="上传您的红包码图像，会自动填写" Width="280px" BorderStyle="Dashed"   />                </td>
               ...
               <td class="auto-style3">
                  <button id="J_btn_sk_scanQR" runat="server" onclick="javascript:FileUpload_SK_SelectFile();" >上传</button>
                   <asp:TextBox ID="TextBox_SK" Text="收款码" MaxLength="200" runat="server" ToolTip="上传您的收款码图像，会自动填写" Width="280px" BorderStyle="Dashed" />                </td>
              </tr>
              ...
              <tr>
                <td colspan="2"><div align="center"><img runat="server" id="img_Example" src="../tools/HB_pic/eaxmple_alpha.png" alt="待生成红包收款码显示区" width="600" height="900" border="2"/></div></td>
              </tr>
            </table>
